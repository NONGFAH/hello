...
func (x *SayHelloRequest) GetUserName() string {
	if x != nil {
		return x.UserName
	}
	return ""
...
var file_HelloGrpc_proto_rawDesc = []byte{
	0x0a, 0x0f, 0x48, 0x65, 0x6c, 0x6c, 0x6f, 0x47, 0x72, 0x70, 0x63, 0x2e, 0x70, 0x72, 0x6f, 0x74,
	...
	0x0a, 0x09, 0x48, 0x65, 0x6c, 0x6c, 0x6f, 0x47, 0x72, 0x70, 0x63, 0x12, 0x31, 0x0a, 0x08, 0x73,
	...
	0x65, 0x6c, 0x6c, 0x6f, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x22, 0x00, 0x42, 0x2e,
	0x0a, 0x10, 0x63, 0x6f, 0x6d, 0x2e, 0x63, 0x61, 0x75, 0x70, 0x64, 0x62, 0x6a, 0x2e, 0x67, 0x72,
	0x70, 0x63, 0x50, 0x01, 0x5a, 0x18, 0x67, 0x69, 0x74, 0x68, 0x75, 0x62, 0x2e, 0x63, 0x6f, 0x6d,
	0x2f, 0x6e, 0x6f, 0x6e, 0x67, 0x66, 0x61, 0x68, 0x2f, 0x68, 0x65, 0x6c, 0x6c, 0x6f, 0x62, 0x06,
...
var file_HelloGrpc_proto_depIdxs = []int32{
	0, // 0: HelloGrpc.sayHello:input_type -> SayHelloRequest
	1, // 1: HelloGrpc.sayHello:output_type -> SayHelloResponse
...
func (c *helloGrpcClient) SayHello(ctx context.Context, in *SayHelloRequest, opts ...grpc.CallOption) (*SayHelloResponse, error) {
	out := new(SayHelloResponse)
	err := c.cc.Invoke(ctx, "/HelloGrpc/sayHello", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (*UnimplementedHelloGrpcServer) SayHello(context.Context, *SayHelloRequest) (*SayHelloResponse, error) {
